...
def KNN_blanaced(feature, target, score_df):
    ...
    trainX, testX, trainY, testY = model_selection.train_test_split(X_resampled, y_resampled, test_size = 0.3, random_state=92313)
...
if __name__ == "__main__":
    ...
    score_df = pd.DataFrame(columns=['Dataset', 'Neighbors', 'Weighting', 'Accuracy_test', 'Accuracy_train', 'Diff in Train&Test Perf'])
